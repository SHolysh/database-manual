...
--***** Note that the MOE_20210119 database needs to compare directly against
--***** the master database
...
select count(*) FROM MOE_20210119.[dbo].[YC_20210119_BH_ID]

select count(*) FROM MOE_20210119.[dbo].[M_D_BOREHOLE]
...
from 
MOE_20210119.dbo.YC_20210119_BH_ID as dloc
) as t1
inner join
(
select
...
,cast(null as int) as new_BH_ID
,ROW_NUMBER() over (order by t1.BORE_HOLE_ID) as rnum
into MOE_20210119.dbo.YC_20210119_new_LOC_ID_BH_ID
from 
(
select
dloc.BORE_HOLE_ID
...
drop table moe_20210119.dbo.yc_20210119_new_loc_id_bh_id
...
,y.rnum
from 
MOE_20210119.dbo.YC_20210119_new_LOC_ID_BH_ID as y
inner join
(
select
t1.new_BH_ID
...
update MOE_20210119.dbo.YC_20210119_new_LOC_ID_BH_ID
set
new_BH_ID=t2.new_BH_ID
from 
MOE_20210119.dbo.YC_20210119_new_LOC_ID_BH_ID as y
