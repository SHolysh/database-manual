...
set
con_bot_ouom= 30
,con_comment= 'Changed CON_BOT_OUOM to 30.0 from -30.0'
where 
sys_record_id= 242247943

update MOE_20210119.dbo.m_d_borehole
set
bh_bottom_elev= 260.35931396484375 - ( 30 *0.3048 )
,bh_bottom_depth= 30 * 0.3048
,bh_bottom_ouom= 30
...
from 
moe_20210119.dbo.m_r_bh_driller_code
...
-- check the con_diameter_unit_ouom
...
from 
moe_20210119.dbo.m_d_location as md
...
delete from MOE_20210119.dbo.m_d_location_purpose
where
sys_record_id in
(
select
