...
,[Static_lev]
,[LEVELS_UOM]
FROM MOE_20220328.[dbo].[TblPump_Test] as moept
inner join
(
select
moetp.PIPE_ID
...
inner join MOE_20220328.dbo.M_D_INTERVAL as dim
...
,cast(524 as int) as DATA_ID
,ROW_NUMBER() over (order by dint.INT_ID) as SYS_RECORD_ID
into MOE_20220328.dbo.M_D_INTERVAL_TEMPORAL_2
from 
MOE_20220328.dbo.TblPipe as moetp
inner join MOE_20220328.dbo.YC_20220328_BH_ID as ycb
on moetp.Bore_Hole_ID=ycb.BORE_HOLE_ID
...
delete from MOE_20220328.dbo.m_d_interval_temporal_2
where 
