...
select
*
into moe_20210119.dbo.M_D_BOREHOLE_bck
from 
moe_20210119.dbo.M_D_BOREHOLE
...
--drop table MOE_20210119.dbo.YC_20210119_DBORE_DRILL_CODES_1
--
--drop table MOE_20210119.dbo.YC_20210119_DBORE_DRILL_CODES_2
--
--drop table MOE_20210119.dbo.YC_20210119_DBORE_DRILL_CODES_3

--drop table MOE_20210119.dbo.M_D_BOREHOLE
--
--select
--*
--into MOE_20210119.dbo.M_D_BOREHOLE
--from 
--MOE_20210119.dbo.M_D_BOREHOLE_bck
...
-- delete those records in the new tables that match the current

delete from MOE_20210119.dbo.YC_20210119_DBORE_DRILL_CODES_3
where loc_id in
(
select
y.loc_id
from 
MOE_20210119.dbo.M_D_BOREHOLE as m
inner join MOE_20210119.dbo.YC_20210119_DBORE_DRILL_CODES_3 as y
on m.loc_id=y.loc_id
where
m.bh_drill_method_code=y.bh_drill_method_code
)

delete from MOE_20210119.dbo.YC_20210119_DBORE_DRILL_CODES_2
where loc_id in
(
select
y.loc_id
from 
MOE_20210119.dbo.M_D_BOREHOLE as m
inner join MOE_20210119.dbo.YC_20210119_DBORE_DRILL_CODES_2 as y
on m.loc_id=y.loc_id
where
m.bh_drill_method_code=y.bh_drill_method_code
)

delete from MOE_20210119.dbo.YC_20210119_DBORE_DRILL_CODES_1
where loc_id in
(
select
y.loc_id
from 
MOE_20210119.dbo.M_D_BOREHOLE as m
inner join MOE_20210119.dbo.YC_20210119_DBORE_DRILL_CODES_1 as y
on m.loc_id=y.loc_id
where
m.bh_drill_method_code=y.bh_drill_method_code
)
...
y2.loc_id
from 
MOE_20210119.dbo.YC_20210119_DBORE_DRILL_CODES_1 as y1
inner join MOE_20210119.dbo.YC_20210119_DBORE_DRILL_CODES_2 as y2
...
y2.loc_id
from 
MOE_20210119.dbo.YC_20210119_DBORE_DRILL_CODES_2 as y1
inner join MOE_20210119.dbo.YC_20210119_DBORE_DRILL_CODES_3 as y2
on y1.loc_id=y2.loc_id
where
y1.bh_drill_method_code=y2.bh_drill_method_code
)
